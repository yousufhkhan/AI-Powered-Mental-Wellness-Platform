  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", background: "#F8F6FF" }}>
      <div style={{ width: 420, background: "#fff", borderRadius: radius.lg, boxShadow: shadows.md, padding: 36 }}>
        <h1 style={{ fontFamily: fonts.display, fontSize: 32, marginBottom: 16, color: colors.text }}>Welcome Back</h1>
        <p style={{ fontFamily: fonts.body, color: colors.textMid, marginBottom: 24 }}>Sign in to continue to your dashboard.</p>
        ...
        <p style={{ marginTop: 16, fontFamily: fonts.body, color: colors.textMid, fontSize: 14 }}>
          Need an account? <Link to="/signup" style={{ color: colors.purple, fontWeight: 700 }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
