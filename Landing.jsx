  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
        ...
        <a href="#" onClick={() => navigate("/login")} style={{ fontFamily: fonts.body, fontSize: 14, fontWeight: 700, color: colors.textMid, textDecoration: "none", cursor: "pointer" }}>Login</a>
        <Button onClick={() => navigate("/signup")} size="sm">Sign Up</Button>
      </div>
    </nav>
  );
};
    ...
    <section style={{ padding: "80px 80px", background: "#fff" }}>
      <div style={{
        ...
        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
          <Button onClick={() => navigate("/signup")} size="lg">Create Free Account</Button>
